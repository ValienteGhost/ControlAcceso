...
public final class ActivityTarjetasBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityTarjetasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTarjetasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tarjetas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTarjetasBinding bind(@NonNull View rootView) {
